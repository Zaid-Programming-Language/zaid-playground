    ...
    div(class: "flex flex-col h-[50vh] w-full sm:h-screen sm:w-1/2 p-4 max-sm:pb-2 sm:pe-2") do
      div(class: "flex justify-between items-center mb-4") do
        ...
        RBUI::DropdownMenu(options: { placement: "bottom-end" }, class: "z-40") do
          ...
          RBUI::DropdownMenuContent(class: "max-h-56 overflow-y-auto", data: { controller: "zaid-examples" }) do
            RBUI::DropdownMenuLabel() { t(".syntax") }
            RBUI::DropdownMenuSeparator()
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "comments" }) { t(".comments") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "variables" }) { t(".variables") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "printing" }) { t(".printing") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "comparison_operations" }) { t(".comparison_operations") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "logical_operations" }) { t(".logical_operations") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "mathematical_operations" }) { t(".mathematical_operations") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "if_statements" }) { t(".if_statements") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "loop_statements" }) { t(".loop_statements") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "methods" }) { t(".methods") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "classes" }) { t(".classes") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "arrays" }) { t(".arrays") }
            RBUI::DropdownMenuLabel() { t(".advanced_examples") }
            RBUI::DropdownMenuSeparator()
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "odd_and_even" }) { t(".odd_and_even") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "mean" }) { t(".mean") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "check_for_leap_year" }) { t(".check_for_leap_year") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "factorial" }) { t(".factorial") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "is_prime_number" }) { t(".is_prime_number") }
            RBUI::DropdownMenuItem(data_action: "zaid-examples#show", data: { example: "prime_numbers" }) { t(".prime_numbers") }
          end
        end
      end
